...
## v273 — TSC Clean Build
- Fixed all TypeScript compile errors in ForgeApp.tsx
- Closed unclosed JSX divs (lines 22752, 24360 cascades resolved)
- Fixed truncated file — appended missing closing tags
- Removed stray G+null byte at line 47635
- Fixed ForgeTab_ndareview2 red_flags div balance
- All 1426+ relative fetch URLs already fixed (v272 work)
- Clean build: 0 TSC errors
