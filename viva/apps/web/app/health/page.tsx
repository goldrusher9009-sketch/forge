...
const ZK_PROOFS = [
  {
    ...
    desc: 'Prove overall health rings meet threshold. No raw data exposed.',
    status: 'active',
    ring: 'activity',
    expires: '2027-08-12',
    threshold: 'V-Score ≥600',
  },
  {
    id: 'location',
    title: 'Location City',
    desc: 'Prove you are in a specific city without revealing exact address.',
    status: 'active',
    ring: 'sleep',
    expires: '2027-07-30',
    threshold: 'City-level only',
  },
  {
    id: 'identity',
    title: 'Identity',
    desc: 'Prove verified identity without revealing personal documents.',
    status: 'pending',
    ring: 'nutrition',
    expires: null,
    threshold: 'KYC-lite',
  },
  {
    id: 'income',
    title: 'Income Range',
    desc: 'Prove income bracket for market access. No exact figure exposed.',
    status: 'none',
    ring: 'wealth',
    expires: null,
