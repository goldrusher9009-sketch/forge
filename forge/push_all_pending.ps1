...
& 'C:\Program Files\Git\cmd\git.exe' -C 'C:\Users\teste\OneDrive\Documents\Claude\Projects' commit -m "feat(forge): Batch12-68: +sugg-history, ws-filters-v2, thread-attach-v2, focus-sessions, intent-log"
