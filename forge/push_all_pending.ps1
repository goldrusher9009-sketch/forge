...
& 'C:\Program Files\Git\cmd\git.exe' -C 'C:\Users\teste\OneDrive\Documents\Claude\Projects' commit -m "feat(forge): Batch12-66: +draft-reviews, ws-milestones, thread-react-v2, energy-log, eval-results"
