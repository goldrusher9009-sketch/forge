...
& 'C:\Program Files\Git\cmd\git.exe' -C 'C:\Users\teste\OneDrive\Documents\Claude\Projects' commit -m "feat(forge): Batch12-36: +prompt-library, ws-connections, ai-glossary, reading-queue-v2, kanban-labels"
