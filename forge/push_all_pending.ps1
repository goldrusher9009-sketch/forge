...
& 'C:\Program Files\Git\cmd\git.exe' -C 'C:\Users\teste\OneDrive\Documents\Claude\Projects' commit -m "feat(forge): Batch12-45: +agent-runs, workspace-policies, knowledge-nodes, chat-reactions-v2, ai-draft-history"
