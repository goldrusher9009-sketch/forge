...
& 'C:\Program Files\Git\cmd\git.exe' -C 'C:\Users\teste\OneDrive\Documents\Claude\Projects' commit -m "feat(forge): Batch8 routes+UI: sentiment timeline, heatmap, complexity, depth, codeblocks, merge candidates"
