...
& 'C:\Program Files\Git\cmd\git.exe' -C 'C:\Users\teste\OneDrive\Documents\Claude\Projects' commit -m "feat(forge): Batch12-17: personas, templates, collections, agenda, goals, captures, graph, journal, habits, flashcards, reading, kanban, digest, snippets, global-search, onboarding"
