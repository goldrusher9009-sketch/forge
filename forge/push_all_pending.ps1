...
& 'C:\Program Files\Git\cmd\git.exe' -C 'C:\Users\teste\OneDrive\Documents\Claude\Projects' commit -m "feat(forge): Batch12-75: +debug-sessions, templates-v2, thread-polls, time-blocks, critique-log"
