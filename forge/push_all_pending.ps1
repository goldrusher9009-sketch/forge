...
& 'C:\Program Files\Git\cmd\git.exe' -C 'C:\Users\teste\OneDrive\Documents\Claude\Projects' commit -m "feat(forge): Batch12-15: personas, focus, templates, collections, agenda, goals, captures, graph, journal, habits, changelog"
