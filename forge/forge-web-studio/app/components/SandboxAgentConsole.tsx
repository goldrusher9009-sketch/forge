...
.sac-shell{padding:26px;min-height:100%;height:100%;overflow-y:auto;box-sizing:border-box;color:var(--fg-text);background:radial-gradient(1000px 520px at 78% -8%,rgba(255,31,53,.10),transparent 58%),linear-gradient(180deg,#09090b,#0b0b0d);font-family:var(--fg-font-ui)}
