...
- current VPS release `2d6fb910ff74904398e4a40f417efc91ee95688f`: Forge, Orchestrator, Sandbox Docker, and internal gateway are healthy with zero restarts. Only Orchestrator was recreated for the v2 archive policy; Forge, Sandbox Docker, the internal gateway, ProjectHash, and Nginx retained their exact container/process identities. Post-switch concurrency again completed three parallel lifecycles, failed closed at global and per-tenant capacity with HTTP 429, returned managed containers and volumes to zero, and preserved the idempotency count at 17;
